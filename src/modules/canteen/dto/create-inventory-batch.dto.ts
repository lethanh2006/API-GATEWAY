...
export class CreateInventoryBatchDto {
  ...
  @ApiProperty({ example: '2026-08-15', description: 'Hạn sử dụng (YYYY-MM-DD)' })
  ...
  @ApiProperty({ example: 'Công ty Thực Phẩm Sạch CP', description: 'Tên nhà cung cấp', required: false })
  @IsOptional()
