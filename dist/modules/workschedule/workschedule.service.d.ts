...
export declare class WorkscheduleService {
    ...
    private forward;
    getPendingRequests(query: Record<string, string>, user: any): Promise<any>;
    getAllRequests(query: Record<string, string>, user: any): Promise<any>;
    approveRequest(id: string, user: any): Promise<any>;
    rejectRequest(id: string, dto: any, user: any): Promise<any>;
    bulkApprove(dto: any, user: any): Promise<any>;
    getHeatmap(query: Record<string, string>, user: any): Promise<any>;
    ...
    getReport(query: Record<string, string>, user: any): Promise<any>;
    getPolicy(): Promise<any>;
    updatePolicy(dto: any, user: any): Promise<any>;
    getMySchedules(query: Record<string, string>, user: any): Promise<any>;
