...
export declare class WorkscheduleController {
    ...
    getPendingRequests(query: Record<string, string>, req: any): Promise<any>;
    getAllRequests(query: Record<string, string>, req: any): Promise<any>;
    ...
    getHeatmap(query: Record<string, string>, req: any): Promise<any>;
    ...
    getReport(query: Record<string, string>, req: any): Promise<any>;
    ...
    getMySchedules(query: Record<string, string>, req: any): Promise<any>;
